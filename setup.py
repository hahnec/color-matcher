...
MAC_FILES = [
        # ('subdir' , ['file_path'])
        ('cfg', ['color_matcher/cfg/cfg.json']),
        ('gui/icns', ['color_matcher/gui/icns/1055104.icns'])
]

WIN_FILES = [
        # ('subdir' , ['file_path'])
        ('gui/icns', ['color_matcher/gui/icns/1055104.ico'])
]
UNIX_FILES = [
        # ('subdir' , ['file_path'])
        ('gui/icns', ['color_matcher/gui/icns/1055104.gif'])
]
